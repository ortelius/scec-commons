...
type CompAttrs struct {
	...
	GitBranchCreateTimestamp string `json:"gitbranchcreatetimestamp,omitempty"`
	...
	GitCommitTimestamp       string `json:"gitcommittimestamp,omitempty"`
	...
	GitVerifyCommit          string `json:"gitverifycommit,omitempty"`
