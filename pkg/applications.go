// Package ortelius - Applications defines the struct and handles marshaling/unmarshaling the struct to/from NFT Storage.
package ortelius
...
func (obj *Applications) UnmarshalNFT(cid2json map[string]string) {
	...
	err := json.Unmarshal([]byte(obj.NftJSON), &apps) // Convert the nft json into the domain object
